	...
	<div class="row">
		<div class="col-md-3">
			...
			<div class="list-group menu-message">
				<a href="inbox.html" class="list-group-item active"><i class="icon-inbox"></i> Bana Özel Sorular <span class="badge pull-right">4</span></a>
				<a href="inbox.html" class="list-group-item active"><i class="icon-inbox"></i> Genel Sorular <span class="badge pull-right">4</span></a>
					...
					<table class="table table-hover table-message">
						<tbody>
							...
							<tr class="unread">
								...
								<td><a  href="{!! action('Doctor\QuestionController@questiondetail' , $question->id) !!}">{!! $question->created_at->format('d.m.Y')  !!}</a></td>

								<td><a  href="{!! action('Doctor\QuestionController@questiondetail' , $question->id) !!}">{!! $question->title !!}</a></td>
