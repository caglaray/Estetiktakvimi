...
<head>
    <meta charset="UTF-8">
    <title>Estetik Takvimi - Doktor Girişi</title>   
            ...
            <div class="full-content-center">
                ...
                <div class="login-wrap animated flipInX">
                    <div class="login-block">
                        ...
                        <form role="form"  method="POST" action="{{ route('docadmin.login.submit') }}">
                         {{ csrf_field() }}
                         <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }} login-input">
                            <i class="fa fa-user overlay"></i>
                            <input type="text" name="email" id="email" class="form-control text-input" value="{{ old('email') }}" required autofocus placeholder="Doktor E-Mail">
                            @if ($errors->has('email'))
