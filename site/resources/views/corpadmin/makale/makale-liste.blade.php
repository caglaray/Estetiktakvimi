						...
						<tr>
							...
							<td>
								<div class="btn-group btn-group-xs">
									...
									<a data-toggle="tooltip" href="{!! action('Kurum\ArticleController@edit' , $article->id) !!}" title="Düzenle" class="btn btn-default"><i class="fa fa-edit"></i></a>

									<a data-toggle="tooltip" href="{!! action('Kurum\ArticleController@silinecek' , $article->id) !!}" title="Sil" class="btn btn-default"><i class="icon-cancel-3"></i></a>
								</div>
							</td>
						</tr>
						@endforeach
