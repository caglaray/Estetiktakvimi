            ...
            <div class="vids_item">
              <div class="row">
                ...
                <div class="col-sm-8">
                  <div class="vids_dt">
                  <figcaption>
                    <a href="#">Saç mezoterapisi neden yapılır? Etkili olması için tekrarlanmalı...</a>
                    </figcaption>
                    <strong>Fatma Öztürk</strong>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="last_articles">
            ...
            <div class="artic_item">
              <div class="row">
                ...
                <div class="col-sm-8">
                  <div class="artic_dt">
                    <a href="#" rel="nofollow" target="_blank">Saç mezoterapisi neden yapılır? Etkili olması için tekrarlanmalı...</a>
                    <strong>Fatma Öztürk</strong>
                  </div>
                </div>
              </div>
